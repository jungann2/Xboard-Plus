...
This guide explains how to migrate from V2board Dev version (2023/10/27) to Xboard-Plus.
...
⚠️ Please complete the basic Xboard-Plus installation first (SQLite not supported):
