...
class ConfigSave extends FormRequest
{
    const RULES = [
        ...
        'email_verify' => 'bool',
        // 本地验证码设置
        'local_captcha_char_enable' => 'integer|in:0,1,2,3',
        'local_captcha_math_enable' => 'integer|in:0,1,2,3',
        'local_captcha_charset' => 'in:number,upper,lower,mixed',
        'local_captcha_length' => 'integer|in:4,5,6,0',
        // 密保卡设置
        'security_card_enable' => 'boolean',
    ...
    public function messages()
    {
        ...
        return [
            ...
            'captcha_enable.in' => '第三方验证码启用范围只能选择 0(关闭)、1(前台)、2(后台)、3(前台+后台)',
            'local_captcha_char_enable.in' => '字符验证码启用范围只能选择 0-3',
            'local_captcha_math_enable.in' => '算术验证码启用范围只能选择 0-3',
            'local_captcha_charset.in' => '字符集只能选择 number、upper、lower 或 mixed',
            'local_captcha_length.in' => '验证码位数只能选择 4、5、6 或随机(0)',
